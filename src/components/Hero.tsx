      ...
      <div className="container mx-auto px-6 relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <h1 className="text-5xl lg:text-6xl font-bold leading-tight">The Future of Students 
Faster
            {" "}
            ...
            {!submitted ? <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
                <Input type="email" placeholder="Enter your email" value={email} onChange={e => setEmail(e.target.value)} required className="flex-1 h-12 text-base" />
                <Button type="submit" size="lg" className="h-12 px-8 shadow-md">
                  Get Early Access
                  <ArrowRight className="ml-2 w-4 h-4" />
                </Button>
              </form> : <div className="flex items-center gap-3 p-4 bg-accent rounded-lg border border-primary/20">
          ...
          <div className="relative lg:block hidden">
            ...
            <img src={heroImage} alt="Healthcare education professionals collaborating" className="relative rounded-3xl shadow-2xl w-full object-cover" />
          </div>
        </div>
      </div>
    </section>;
