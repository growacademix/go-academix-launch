...
const leaders = [
  ...
  },
  {
    ...
    bio: "Mason is the Chief Product Officer at GO ACADEMIX, where he leads product strategy, user experience, and platform development. He is also the CTO and Educational Technologist at Allied Health Career Training, a role he has held since 2018, building the systems that run a multi-state allied health school. Since 2012, he has also served as an Information Resource Specialist at the University of Kansas School of Pharmacy, consulting on educational technology and solving real classroom and administrative problems. That combination, a healthcare school operator plus a university technologist, gives Mason a rare perspective on what schools need and where software usually falls short. At GO ACADEMIX, he uses that experience to build tools that are practical from day one and actually make life easier for the people using them.",
  },
];
