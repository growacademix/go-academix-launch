...
const leaders = [
  ...
  },
  {
    ...
    bio: "Mason is the Chief Product Officer at GO ACADEMIX, where he leads product strategy, user experience, and platform development. Before joining Allied Health Career Training, he spent 12 years as an Information Resource Specialist in Information Technology at the University of Kansas School of Pharmacy, consulting on educational technology and solving real classroom and administrative problems. Today, as CTO and Educational Technologist at Allied Health Career Training, he builds the systems that run a multi-state allied health school. That combination, a university technologist who then became a school operator, gives Mason a rare perspective on what schools need and where software usually falls short. At GO ACADEMIX, he uses that experience to build tools that are practical from day one and actually make life easier for the people using them.",
  },
];
