...
const leaders = [
  {
    ...
    linkedIn: "https://www.linkedin.com/in/jocelyngpowell/",
  ...
  },
  {
    ...
    linkedIn: "https://www.linkedin.com/in/connor-dane-powell-65a00578/",
  ...
  },
  {
    ...
    linkedIn: "https://www.linkedin.com/in/mason-powell-07254329/",
    bio: "Mason is the Chief Product Officer at GO ACADEMIX, where he leads product strategy, user experience, and platform development. He is also the CTO and Educational Technologist at Allied Health Career Training, a role he has held since 2018. In that capacity, Mason has built and maintained the systems that run a multi-state allied health school, from enrollment and payments to compliance tracking and student records. Since 2012, he has also served as an Information Resource Specialist at the University of Kansas School of Pharmacy, where he consults with faculty, staff, and students on educational technology and solves real classroom and administrative problems every day. That combination, a healthcare school operator plus a university technologist, gives Mason a rare perspective. He has seen what schools need, what students struggle with, and where software usually falls short. At GO ACADEMIX, he uses that experience to build tools that are practical from day one and actually make life easier for the people using them.",
  },
];
