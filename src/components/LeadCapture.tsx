            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Drop your email and we'll send occasional product updates, lessons from running our own school, and early access when new features ship. No spam — you can unsubscribe anytime.
                </p>
              </div>
